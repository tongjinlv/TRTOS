...
#line 641 "..\\Libraries\\STM32L1xx_StdPeriph_Driver\\inc\\stm32l1xx_adc.h"
...
#line 87 "..\\Libraries\\STM32L1xx_StdPeriph_Driver\\src\\stm32l1xx_adc.c"
#line 88 "..\\Libraries\\STM32L1xx_StdPeriph_Driver\\src\\stm32l1xx_adc.c"
...
void ADC_StructInit(ADC_InitTypeDef* ADC_InitStruct)                            
{
  ...
  ADC_InitStruct->ADC_ExternalTrigConv = ((uint32_t)0x03000000);
...
void ADC_CommonInit(ADC_CommonInitTypeDef* ADC_CommonInitStruct)                           
{
  ...
  tmpreg = ((ADC_Common_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2700))->CCR;

    
  tmpreg &= ((uint32_t)0xFFFCFFFF);
  
                   
  tmpreg |= (uint32_t)(ADC_CommonInitStruct->ADC_Prescaler);        
                
   
  ((ADC_Common_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2700))->CCR = tmpreg;
}
...
void ADC_BankSelection(ADC_TypeDef* ADCx, uint8_t ADC_Bank)
{
  ...
  if (ADC_Bank != ((uint8_t)0x00))
  {
     
    ADCx->CR2 |= (uint32_t)((uint32_t)0x00000004);
  }
  else
  {
...
void ADC_TempSensorVrefintCmd(FunctionalState NewState)                
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((ADC_Common_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2700))->CCR |= (uint32_t)((uint32_t)0x00800000);
  }
  else
  {
...
void ADC_RegularChannelConfig(ADC_TypeDef* ADCx, uint8_t ADC_Channel, uint8_t Rank, uint8_t ADC_SampleTime)
{
  ...
  if (ADC_Channel > ((uint8_t)0x1D))
  {
     
    tmpreg1 = ADCx->SMPR0;
     
    tmpreg2 = ((uint32_t)0x00000007) << (3 * (ADC_Channel - 30));
  ...
  else if (ADC_Channel > ((uint8_t)0x13))
  {
     
    tmpreg1 = ADCx->SMPR1;
     
    tmpreg2 = ((uint32_t)0x00000007) << (3 * (ADC_Channel - 20));
  ...
  else if (ADC_Channel > ((uint8_t)0x09))
  {
  ...
  else if (Rank < 25)
  {
    ...
    tmpreg2 = ((uint32_t)0x0000001F) << (5 * (Rank - 19));
  ...
  else
  {
    ...
    tmpreg2 = ((uint32_t)0x0000001F) << (5 * (Rank - 25));
...
void ADC_InjectedChannelConfig(ADC_TypeDef* ADCx, uint8_t ADC_Channel, uint8_t Rank, uint8_t ADC_SampleTime)
{
  ...
  tmpreg2 = (uint32_t)(((uint32_t)0x0000001F) << (5 * (uint8_t)((Rank + 3) - (tmpreg3 + 1))));
...
uint16_t ADC_GetInjectedConversionValue(ADC_TypeDef* ADCx, uint8_t ADC_InjectedChannel)
{
  ...
  tmp = (uint32_t)ADCx;
  tmp += ADC_InjectedChannel + ((uint8_t)0x30);
