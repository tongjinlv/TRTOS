...
#line 227 "..\\Libraries\\STM32L1xx_StdPeriph_Driver\\inc\\stm32l1xx_aes.h"
...
#line 74 "..\\Libraries\\STM32L1xx_StdPeriph_Driver\\src\\stm32l1xx_aes.c"
#line 75 "..\\Libraries\\STM32L1xx_StdPeriph_Driver\\src\\stm32l1xx_aes.c"
...
void AES_DeInit(void)
{
  ...
  RCC_AHBPeriphResetCmd(((uint32_t)0x08000000), ENABLE);
   
  RCC_AHBPeriphResetCmd(((uint32_t)0x08000000), DISABLE);
}
...
void AES_Init(AES_InitTypeDef* AES_InitStruct)
{
  ...
  tmpreg = ((AES_TypeDef *) ((uint32_t)0x50060000))->CR;
  
   
  tmpreg &= (uint32_t)((uint32_t)0xFFFFFF81);
  
  tmpreg |= (AES_InitStruct->AES_Operation | AES_InitStruct->AES_Chaining | AES_InitStruct->AES_DataType);

  ((AES_TypeDef *) ((uint32_t)0x50060000))->CR = (uint32_t) tmpreg;
}
...
void AES_KeyInit(AES_KeyInitTypeDef* AES_KeyInitStruct)
{
  ((AES_TypeDef *) ((uint32_t)0x50060000))->KEYR0 = AES_KeyInitStruct->AES_Key0;
  ((AES_TypeDef *) ((uint32_t)0x50060000))->KEYR1 = AES_KeyInitStruct->AES_Key1;
  ((AES_TypeDef *) ((uint32_t)0x50060000))->KEYR2 = AES_KeyInitStruct->AES_Key2;
  ((AES_TypeDef *) ((uint32_t)0x50060000))->KEYR3 = AES_KeyInitStruct->AES_Key3;
}
...
void AES_IVInit(AES_IVInitTypeDef* AES_IVInitStruct)
{
  ((AES_TypeDef *) ((uint32_t)0x50060000))->IVR0 = AES_IVInitStruct->AES_IV0;
  ((AES_TypeDef *) ((uint32_t)0x50060000))->IVR1 = AES_IVInitStruct->AES_IV1;
  ((AES_TypeDef *) ((uint32_t)0x50060000))->IVR2 = AES_IVInitStruct->AES_IV2;
  ((AES_TypeDef *) ((uint32_t)0x50060000))->IVR3 = AES_IVInitStruct->AES_IV3;
}
...
void AES_Cmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((AES_TypeDef *) ((uint32_t)0x50060000))->CR |= (uint32_t) ((uint32_t)0x00000001);    
  }
  else
  {
...
void AES_StructInit(AES_InitTypeDef* AES_InitStruct)
{
  AES_InitStruct->AES_Operation = ((uint32_t)0x00000000);
  AES_InitStruct->AES_Chaining = ((uint32_t)0x00000000);
  AES_InitStruct->AES_DataType = ((uint32_t)0x00000000);
}
...
void AES_WriteSubData(uint32_t Data)
{
  ...
  ((AES_TypeDef *) ((uint32_t)0x50060000))->DINR = Data;
}
...
uint32_t AES_ReadSubData(void)
{
  ...
  return ((AES_TypeDef *) ((uint32_t)0x50060000))->DOUTR;
}
...
void AES_ReadKey(AES_KeyInitTypeDef* AES_KeyInitStruct)
{
  AES_KeyInitStruct->AES_Key0 = ((AES_TypeDef *) ((uint32_t)0x50060000))->KEYR0;
  AES_KeyInitStruct->AES_Key1 = ((AES_TypeDef *) ((uint32_t)0x50060000))->KEYR1;
  AES_KeyInitStruct->AES_Key2 = ((AES_TypeDef *) ((uint32_t)0x50060000))->KEYR2;
  AES_KeyInitStruct->AES_Key3 = ((AES_TypeDef *) ((uint32_t)0x50060000))->KEYR3;
}
...
void AES_ReadIV(AES_IVInitTypeDef* AES_IVInitStruct)
{
  AES_IVInitStruct->AES_IV0 = ((AES_TypeDef *) ((uint32_t)0x50060000))->IVR0;
  AES_IVInitStruct->AES_IV1 = ((AES_TypeDef *) ((uint32_t)0x50060000))->IVR1;
  AES_IVInitStruct->AES_IV2 = ((AES_TypeDef *) ((uint32_t)0x50060000))->IVR2;
  AES_IVInitStruct->AES_IV3 = ((AES_TypeDef *) ((uint32_t)0x50060000))->IVR3;
}
...
void AES_DMAConfig(uint32_t AES_DMATransfer, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((AES_TypeDef *) ((uint32_t)0x50060000))->CR |= (uint32_t) AES_DMATransfer;
  }
  else
  {
...
void AES_ITConfig(uint32_t AES_IT, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((AES_TypeDef *) ((uint32_t)0x50060000))->CR |= (uint32_t) AES_IT;     
  }
  else
  {
    ((AES_TypeDef *) ((uint32_t)0x50060000))->CR &= (uint32_t)(~AES_IT);   
...
FlagStatus AES_GetFlagStatus(uint32_t AES_FLAG)
{
  ...
  if ((((AES_TypeDef *) ((uint32_t)0x50060000))->SR & AES_FLAG) != (uint32_t)RESET)
  {
    bitstatus = SET;
  }
  else
...
void AES_ClearFlag(uint32_t AES_FLAG)
{
  ...
  if (AES_FLAG == ((uint32_t)0x00000001))
  {
     
    ((AES_TypeDef *) ((uint32_t)0x50060000))->CR |= (uint32_t) ((uint32_t)0x00000080);
  }
  else  
  {
     
    ((AES_TypeDef *) ((uint32_t)0x50060000))->CR |= (uint32_t) ((uint32_t)0x00000100);
  }
}
...
ITStatus AES_GetITStatus(uint32_t AES_IT)
{
  ...
  cciebitstatus = ((AES_TypeDef *) ((uint32_t)0x50060000))->CR & ((uint32_t)0x00000200);
  ccfbitstatus =  ((AES_TypeDef *) ((uint32_t)0x50060000))->SR & ((uint32_t)0x00000001);

   
  if (AES_IT == ((uint32_t)0x00000200))
  {
  ...
  else  
  {
    ...
    if ((((AES_TypeDef *) ((uint32_t)0x50060000))->CR & ((uint32_t)0x00000400)) != RESET)
    {
       
      if ((((AES_TypeDef *) ((uint32_t)0x50060000))->SR & (uint32_t)(((uint32_t)0x00000004) | ((uint32_t)0x00000002))) != (uint16_t)RESET)
      {
...
void AES_ClearITPendingBit(uint32_t AES_IT)
{
  ...
  ((AES_TypeDef *) ((uint32_t)0x50060000))->CR |= (uint32_t) (AES_IT >> (uint32_t) 0x00000002);
}
