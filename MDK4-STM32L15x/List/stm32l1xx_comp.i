...
#line 178 "..\\Libraries\\STM32L1xx_StdPeriph_Driver\\inc\\stm32l1xx_comp.h"
...
#line 78 "..\\Libraries\\STM32L1xx_StdPeriph_Driver\\src\\stm32l1xx_comp.c"
...
void COMP_DeInit(void)
{
  ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x7C00))->CSR = ((uint32_t)0x00000000);     
}
...
void COMP_Init(COMP_InitTypeDef* COMP_InitStruct)
{
  ...
  tmpreg = ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x7C00))->CSR;

    
  tmpreg &= (uint32_t) (~(uint32_t) (((uint32_t)0x00E00000) | ((uint32_t)0x001C0000) | ((uint32_t)0x00001000)));
  ...
  ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x7C00))->CSR = tmpreg;  
}
...
void COMP_Cmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x7C00))->CSR |= (uint32_t) ((uint32_t)0x00000010);
  }
  else
  {
...
uint8_t COMP_GetOutputLevel(uint32_t COMP_Selection)
{
  ...
  if(COMP_Selection == ((uint32_t)0x00000001))
  {
     
    if((((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x7C00))->CSR & ((uint32_t)0x00000080)) != (uint8_t) RESET)
    {
       
      compout = (uint8_t) ((uint32_t)0x00000001);
    }
     
    else
    {
       
      compout = (uint8_t) ((uint32_t)0x00000000);
    }
  }
  ...
  else
  {
    ...
    if((((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x7C00))->CSR & ((uint32_t)0x00002000)) != (uint8_t) RESET)
    {
...
void COMP_SW1SwitchConfig(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x7C00))->CSR |= (uint32_t) ((uint32_t)0x00000020);
  }
  else
  {
...
void COMP_WindowCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x7C00))->CSR |= (uint32_t) ((uint32_t)0x00020000);
  }
  else
  {
...
void COMP_VrefintOutputCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x7C00))->CSR |= (uint32_t) ((uint32_t)0x00010000);
  }
  else
  {
