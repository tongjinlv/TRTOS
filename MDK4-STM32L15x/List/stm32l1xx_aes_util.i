...
#line 52 "..\\Libraries\\STM32L1xx_StdPeriph_Driver\\src\\stm32l1xx_aes_util.c"
...
ErrorStatus AES_ECB_Encrypt(uint8_t* Key, uint8_t* Input, uint32_t Ilength, uint8_t* Output)
{
  ...
  AES_InitStructure.AES_Operation = ((uint32_t)0x00000000);
  AES_InitStructure.AES_Chaining = ((uint32_t)0x00000000);
  AES_InitStructure.AES_DataType = ((uint32_t)0x00000004);
  ...
  for(i = 0; ((i < Ilength) && (status != ERROR)); i += 16)
  {
    ...
    do
    {
      ccstatus = AES_GetFlagStatus(((uint32_t)0x00000001));
      counter++;
    }while((counter != ((uint32_t) 0x00010000)) && (ccstatus == RESET));
    ...
    else
    {
      ...
      AES_ClearFlag(((uint32_t)0x00000001));
...
ErrorStatus AES_ECB_Decrypt(uint8_t* Key, uint8_t* Input, uint32_t Ilength, uint8_t* Output)
{
  ...
  AES_InitStructure.AES_Operation = ((uint32_t)0x00000018);
  AES_InitStructure.AES_Chaining = ((uint32_t)0x00000000);
  AES_InitStructure.AES_DataType = ((uint32_t)0x00000004);
  AES_Init(&AES_InitStructure);
...
ErrorStatus AES_CBC_Encrypt(uint8_t* Key, uint8_t InitVectors[16], uint8_t* Input, uint32_t Ilength, uint8_t* Output)
{
  ...
  AES_InitStructure.AES_Operation = ((uint32_t)0x00000000);
  AES_InitStructure.AES_Chaining = ((uint32_t)0x00000020);
  AES_InitStructure.AES_DataType = ((uint32_t)0x00000004);
  AES_Init(&AES_InitStructure);
...
ErrorStatus AES_CTR_Encrypt(uint8_t* Key, uint8_t InitVectors[16], uint8_t* Input, uint32_t Ilength, uint8_t* Output)
{
  ...
  AES_InitStructure.AES_Operation = ((uint32_t)0x00000000);
  AES_InitStructure.AES_Chaining = ((uint32_t)0x00000040);
  AES_InitStructure.AES_DataType = ((uint32_t)0x00000004);
  AES_Init(&AES_InitStructure);
