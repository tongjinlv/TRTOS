...
#include <..\USER\Prj_TP500\Sensor_Driver.h>
...
const COM_MenuStruct MenuList[]={
	...
	{"蜂鸣器测试",(void *)&BEEP_Double,VT_Task,Null},
	{"电话号码:%s",(void *)&UIShowValue.SaveValue.CallNumber[0][0],VT_Str,sizeof(UIShowValue.SaveValue.CallNumber[0])},
	{"电话号码:%s",(void *)&UIShowValue.SaveValue.CallNumber[1][0],VT_Str,sizeof(UIShowValue.SaveValue.CallNumber[1])},
	{"主机[1]:%s",(void *)&UIShowValue.SaveValue.DomainName[0][0],VT_Str,sizeof(UIShowValue.SaveValue.DomainName[0])},
	{"主机[2]:%s",(void *)&UIShowValue.SaveValue.DomainName[1][0],VT_Str,sizeof(UIShowValue.SaveValue.DomainName[1])},
