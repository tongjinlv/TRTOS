...
http://www.trtos.com/
**************************************************************************************/
#include <..\USER\Prj_USBLora\spi.h>
#include <GPIO_Driver.h>
#include <..\USER\Prj_USBLora\ini.h>

const GPIO_InitStruct Pin_Maps[]=//新版本
{
	{GPIO_Speed_50MHz,GPIO_Mode_Out_PP,GPIOC,GPIO_Pin_14},//mosi
	{GPIO_Speed_50MHz,GPIO_Mode_IPU,GPIOC,GPIO_Pin_13},//miso
	{GPIO_Speed_50MHz,GPIO_Mode_Out_PP,GPIOC,GPIO_Pin_15},//sck
	{GPIO_Speed_50MHz,GPIO_Mode_Out_PP,GPIOB,GPIO_Pin_7},//cs
	{GPIO_Speed_50MHz,GPIO_Mode_Out_PP,GPIOB,GPIO_Pin_5},//reset
	{GPIO_Speed_50MHz,GPIO_Mode_IPU,GPIOB,GPIO_Pin_6},//rxtx
	{GPIO_Speed_50MHz,GPIO_Mode_IPU,GPIOB,GPIO_Pin_8},//io0
	{0},
};
void SpiInit( void )
{
